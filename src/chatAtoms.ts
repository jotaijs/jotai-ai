...
export function chatAtoms (
  ...
  > & {
    ...
    experimental_onFunctionCall?: (
      get: Getter,
      set: Setter,
      ...args: Parameters<Required<UseChatOptions>['experimental_onFunctionCall']>
  ...
  async function triggerRequest (
    ...
    try {
      ...
      const experimental_onFunctionCall = chatOptions.experimental_onFunctionCall
      await processChatStream({
        ...
        experimental_onFunctionCall: experimental_onFunctionCall
          ? (chatMessages, functionCall) => {
            return experimental_onFunctionCall(get, set, chatMessages,
              functionCall)
          }
          : undefined,
